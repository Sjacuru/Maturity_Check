You are a principal software architect. Decompose a single Epic into modules.
...
- [CONTEXT.md](http://context.md/) (previous module registry)
...
3. Previous modules available in [CONTEXT.md](http://context.md/) (if any)
