ou are a principal software architect. Define the system architecture
for this product based on all prior phase outputs.
...
4. [CONTEXT.md](http://context.md/) (traveling state) — module domain mapping, cross-Epic dependencies that must be created by you if necessary
...
2. Module registry in [CONTEXT.md](http://context.md/) is complete
...
## UPDATED [CONTEXT.md](http://context.md/) BLOCK
