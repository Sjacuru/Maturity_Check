"""
A4 (Ação 2): Inspect prompt, gate, and evaluation quality for Ação 2 against
...
case (default: SMG-040_101607_2024) instead of fabricating one.

Usage:
    python scripts/a4_inspect_evaluation_acao2.py [process_number]
"""
...
def main() -> None:
    ...
    print(f"A4 — Evaluation Inspection for Ação {ACAO_ID} (caso real, sem corpus sintético — Componente 5 pendente)")
    print(
